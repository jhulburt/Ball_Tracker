...
# rosrun balltracker ball_move.py
...
[MIN_Z, MAX_Z] 			= [ 0.04, 0.4]		# [meters]

[MIN_SPEED, MAX_SPEED] 	= [ 0.2, 0.8]		# [m/s].  Specify the allowable range of speeds for the model.

MODEL_NAME				= 'blue_ball'		# Name of the Gazebo model/object we're moving.
